...
export default function MapView({
  ...
  // Normaliza os nomes dos distritos para garantir correspondência entre o GeoJSON e os dados estatísticos
  ...
  // Define escalas de cor diferentes consoante o indicador selecionado
